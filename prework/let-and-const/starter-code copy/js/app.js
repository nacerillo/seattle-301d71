...
function displayPics(){
 ...
 // console.log(rando);
  ...
  // The line console.log(rando) threw an error because let = rando was declared within scope of a while loop, and we are trying to console.log its value OUTSIDE of its scope. 
  // Unlike with var, we cannot call on a variable defined with 'let' unless we call it within the same code-block that the variable is declared in. 
  console.log(viewed);
